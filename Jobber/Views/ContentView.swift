...
struct ContentView: View {
    ...
    @StateObject var jobVM: JobsViewModel = JobsViewModel()
    ...
    var body: some View {
        NavigationView {
                ...
                }.background(NavigationLink(destination: JobsView().environmentObject(jobVM), isActive: $goToJobs) {})
                .navigationTitle("Jobber !")
